...
const Project = () => {
  ...
  return (
    <section className={`c-space mt-20`} id={"projects"}>
      <p className={`head-text`}>My Work</p>
      <div className={`grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full`}>
        <div
          className={`flex flex-col gap-5 relative sm:p-10 px-5 shadow-2xl shadow-black-200`}
        >
          ...
          <div className={`flex flex-col text-white-600 my-5`}>
            ...
            <p className={`animatedText`}>{currentProject.subdescdesc}</p>
          </div>
            ...
            <Center>
              <Suspense fallback={<CanvasLoader />}>
                <group scale={2} position={[0, -3, 0]} rotation={[0, -0.1, 0]}>
                  <DemoProjects texture={currentProject.texture} />
                </group>
              </Suspense>
            </Center>
